...
<?php
	...
	if ($res->num_rows > 0)		
	{
		...
		echo'<tr>
				...
				<th style="color: #FFF;background:#009688"><div align="center">Tarea 1</div></th>
				<th style="color: #FFF;background:#009688"><div align="center">Tarea 2</div></th>
				<th style="color: #FFF;background:#009688"><div align="center">Tarea 3</div></th>
				<th style="color: #FFF;background:#009688"><div align="center">Tarea 4</div></th>										
				<th style="color: #FFF;background:#009688"><div align="center">Tarea 5</div></th>	
			</tr>';
			...
			
		{
			...
			echo '<td><input type="hidden" name="nombre_mascota" value="'.$muestra->tarea1.'"/>'.htmlentities($muestra->tarea1).'</td>';
			echo '<td><input type="hidden" name="nombre_mascota" value="'.$muestra->tarea2.'"/>'.htmlentities($muestra->tarea2).'</td>';
			echo '<td><input type="hidden" name="nombre_mascota" value="'.$muestra->tarea3.'"/>'.htmlentities($muestra->tarea3).'</td>';
			echo '<td><input type="hidden" name="nombre_mascota" value="'.$muestra->tarea4.'"/>'.htmlentities($muestra->tarea4).'</td>';
			echo '<td><input type="hidden" name="nombre_mascota" value="'.$muestra->tarea5.'"/>'.htmlentities($muestra->tarea5).'</td>';
			echo '</tr>';
